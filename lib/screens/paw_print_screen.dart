...
class PawPrintScreen extends StatefulWidget {
  const PawPrintScreen({super.key});

  @override
  State<PawPrintScreen> createState() => _PawPrintScreenState();
}

class _PawPrintScreenState extends State<PawPrintScreen> with SingleTickerProviderStateMixin {
  Uint8List? _pawPrintImage;
  String _statusMessage = "Press 'Capture Paw Print' to start";
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CameraView(
          title: 'Paw Print Camera',
          guideText: 'Place paw print here',
  ...
  void _handleCapturedImage(XFile image) {
    ...
    File(image.path).readAsBytes().then((bytes) {
      setState(() {
        _pawPrintImage = bytes;
        _isCapturing = false;
        _showImage = true;
        _statusMessage = "Paw print captured successfully!";
      });
    }).catchError((error) {
      setState(() {
        _isCapturing = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paw Print Scanner'),
        elevation: 0,
      ),
      body: SafeArea(
        child: Column(
                    ...
                    children: [
                      ...
                      FadeTransition(
                        ...
                        child: SlideTransition(
                          ...
                          child: Text(
                            'Capture a clear image of the paw print',
                            style: TextStyle(
                            ...
                            child: _pawPrintImage != null
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                    'Use the camera to capture a paw print',
                                    style: TextStyle(
                                      color: Colors.grey[500],
                                      fontSize: 12,
                                    ),
